...
function getIconTabs(menu) {
    switch (menu) {
        ...
        case LANG.getTranslation('My List'):
            return RegularIcons.playCircle;
            break;
        case LANG.getTranslation('Downloads'):
            return SolidIcons.download;
            break;
        case LANG.getTranslation('CatchupTV'):
            return SolidIcons.history;
            break;
        case LANG.getTranslation('Education'):
            return SolidIcons.school;
            break;
        default:
            //this is an app menu
            break;
